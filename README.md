...
Then you can interact with taskbot by typing `taskbot help`.

    taskbot> taskbot help
    taskbot animate me <query> - The same thing as `image me`, except adds [snip]
    taskbot help - Displays all of the help commands that taskbot knows about.
    ...
